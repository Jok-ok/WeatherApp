...
private extension CitySearchTableViewController {
    func setupTableViewInitialState(with weatherHeaderViewModel: SectionHeaderModel,
        ...
        customTableView.setupTableViewInitialState(
            with: weatherHeaderViewModel,
            cityHeaderViewModel: cityHeaderViewModel,
            favoriteSectionHeaderModel: favoriteSectionHeaderModel
        )
