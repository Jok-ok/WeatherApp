...
extension CityWeatherViewController: CityWeatherViewProtocol {
    func setupInitialState(with model: CityWeatherViewData) {
        ...
        setupTableViewInitialState(with: model.currentWeatherSectionHeader, dailyForcastSectionHeader: model.dailyForecastWeatherSectionHeader, hourlyForecastSectionHeader: model.hourlyForcastWeatherSectionHeader)
    }
    
    private func setupTableViewInitialState(with currentWeatherSectionHeader: String, dailyForcastSectionHeader: String, hourlyForecastSectionHeader: String) {
